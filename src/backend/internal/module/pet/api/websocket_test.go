...
func (stubService) Pet(context.Context, uuid.UUID) (*domain.Pet, error)   { return nil, nil }
...
func TestWebSocketPing(t *testing.T) {
	...
	server := httptest.NewUnstartedServer(NewWebSocketHandler(stubService{}, stubTokens{actor: actor}, nil))
