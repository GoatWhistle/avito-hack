...
| `<имя участника>` | Фронтенд | Дизайн-система и токены, экраны питомца, наград, лидерборда и объявлений, живой Lottie-персонаж и микровзаимодействия, WebSocket-клиент с переподключением, TanStack Query и валидация ответов через zod, локализация ru/en, тесты Vitest |
